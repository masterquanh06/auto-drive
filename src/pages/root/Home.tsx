      ...
      <section className="w-full py-12">
        <div className="container mx-auto px-10">
          ...
          <div className="flex space-x-4 mb-2">
            <button
              onClick={() => handleFilter("inStock")}
              className={`cursor-pointer py-1 relative after:lg:absolute after:lg:bottom-0 after:lg:left-0 after:lg:bg-slate-900 dark:after:bg-amber-700 hover:after:lg:w-full after:lg:h-0.5 after:lg:w-0 text-emerald-light:w-full after:lg:transition-all after:lg:ease-in-out after:lg:duration-300 ${
                filter === "inStock" ? "text-amber-700" : "text-gray-800"
              } hover:text-amber-700 transition`}
            >
              In Stock
            </button>
            <button
              onClick={() => handleFilter("newCars")}
              className={`cursor-pointer py-1 relative after:lg:absolute after:lg:bottom-0 after:lg:left-0 after:lg:bg-slate-900 dark:after:bg-amber-700 hover:after:lg:w-full after:lg:h-0.5 after:lg:w-0 text-emerald-light:w-full after:lg:transition-all after:lg:ease-in-out after:lg:duration-300 ${
                filter === "newCars" ? "text-amber-700" : "text-gray-800"
              } hover:text-amber-700 transition`}
            >
              New Cars
            </button>
            <button
              onClick={() => handleFilter("usedCars")}
              className={`cursor-pointer py-1 relative after:lg:absolute after:lg:bottom-0 after:lg:left-0 after:lg:bg-slate-900 dark:after:bg-amber-700 hover:after:lg:w-full after:lg:h-0.5 after:lg:w-0 text-emerald-light:w-full after:lg:transition-all after:lg:ease-in-out after:lg:duration-300 ${
                filter === "usedCars" ? "text-amber-700" : "text-gray-800"
              } hover:text-amber-700 transition`}
            >
              Used Cars
            </button>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 mt-6">
            {filteredVehicles.map((vehicle) => (
              <div key={vehicle.id} className="bg-white rounded-lg border border-gray-200 overflow relative">
                {vehicle.tag && (
                  <span className="absolute top-2 left-2 bg-green-500 text-white text-xs px-2 py-1 rounded">
                    {vehicle.tag}
                  </span>
          ...
          <div className="flex justify-center space-x-4 mt-10">
            <button className="bg-gray-300 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-400 transition cursor-pointer">&lt;</button>
            <button className="bg-gray-300 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-400 transition cursor-pointer">&gt;</button>
          </div>
          <div className="container mx-auto flex flex-col md:flex-row items-center mt-10">
            <div className="w-full md:w-1/2 flex justify-center pt-8">
          ...
          <section className="container mx-auto py-12 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white rounded-lg overflow-hidden relative">
              <span className="absolute top-4 left-4 bg-white text-gray-700 text-sm px-3 py-2 rounded-full font-semibold">Sound</span>
            ...
            <div className="bg-white rounded-lg overflow-hidden relative">
              <span className="absolute top-4 left-4 bg-white text-gray-700 text-sm px-3 py-2 rounded-full font-semibold">Accessories</span>
            ...
            <div className="bg-white rounded-lg overflow-hidden relative">
              <span className="absolute top-4 left-4 bg-white text-gray-700 text-sm px-3 py-2 rounded-full font-semibold">Exterior</span>
